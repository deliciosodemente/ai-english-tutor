...
export class GdmLiveAudioVisuals extends LitElement {
  ...
  // FIX: LitElement lifecycle methods like firstUpdated should be protected, not private.
  ...
  // FIX: The render method must be public or protected to be called by LitElement's lifecycle.
  protected render() {
